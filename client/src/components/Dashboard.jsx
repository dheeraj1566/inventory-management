...
function Dashboard() {
  return (
    <div className="left_side bg-blue-950 h-full text-amber-50 w-1/6">
      <div className="dashboard">
        ...
        <ul>
          ...
          <Link to="/report">
           ...
           <li className="py-300 text-lg hover:font-bold hover:bg-gray-50 hover:text-blue-900 text-blue-50 px-5  border-b-1"></li> 
        </ul>
